package io.codebuddy.userservice.domain.form.login.security.provider;

import io.codebuddy.userservice.domain.common.security.auth.MemberDetails;
import io.codebuddy.userservice.domain.form.login.security.auth.MemberPrincipalDetailService;
