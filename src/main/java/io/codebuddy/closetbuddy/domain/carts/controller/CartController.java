...
import io.codebuddy.closetbuddy.domain.carts.Dto.CartItemUpdateDto;
...
public class CartController {
    ...
    private final CartAddRequestDto cartAddRequestDto;

    public CartController(CartService cartService, CartAddRequestDto cartAddRequestDto) {
        this.cartService = cartService;
        this.cartAddRequestDto = cartAddRequestDto;
    }
            ...
            )
    {
        ...
        return ResponseEntity.ok(cartItenId);
    }
